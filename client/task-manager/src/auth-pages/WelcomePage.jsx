            ...
            <div className="w-screen h-screen bg-my-back flex justify-center items-center">
                <div className="h-2/3 w-full xl:w-1/2 flex flex-col justify-center items-center">
                    <div className="w-full h-2/3 flex flex-col justify-center items-center gap-10">
                        <h2 className="font-roboto font-black text-4xl sm:text-5xl text-my-blue3 text-center">Welcome to TaskManager</h2>
                        <img className="animate-scale-pulse w-30 sm:w-50" src="/logo.png" alt="logo-pic" />
                    </div>
                    <div className="w-full h-1/3 flex flex-col sm:flex-row xl:flex-col justify-center items-center gap-5 ">
                        <div onClick={() => navigate('/signin')}  
                        className="flex border-4 border-my-blue3 rounded-3xl w-1/2 sm:w-1/3 lg:w-1/8 xl:w-1/4 h-1/3 justify-center items-center gap-2 cursor-pointer hover:scale-102 duration-200 ease-in-out">
