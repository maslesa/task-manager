            ...
            <div className="w-screen h-screen bg-my-back flex justify-center items-center">
                <div className="h-2/3 w-1/2 flex flex-col justify-center items-center">
                    <div className="w-full h-2/3 flex flex-col justify-center items-center gap-10">
                        <h2 className="font-roboto font-black text-5xl text-my-blue3">Welcome to TaskManager</h2>
                        <img className="animate-scale-pulse w-50" src="/logo.png" alt="logo-pic" />
                    </div>
                    <div className="w-full h-1/3 flex flex-col justify-center items-center gap-5">
