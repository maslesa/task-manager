...
function UncompletedTasksComponent() {
    ...
    const fetchUncompletedTasks = async () => {
        const res = await axios.get(`${import.meta.env.VITE_API_BASE_URL}/task/uncompleted`, axiosConfig);
            ...
            <div className="w-3/4 lg:w-2/3 h-full flex flex-col mb-10">
                <div className="flex items-center justify-between mb-5">
                    <div className="flex gap-1 justify-baseline items-center">
                        ...
                        <h2 className="font-roboto font-black text-2xl sm:text-3xl text-my-blue3">Uncompleted tasks</h2>
                    </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3">
                    {uncompletedTasks && uncompletedTasks.length > 0 ?
                        (uncompletedTasks.map((task) => {
                            ...
                            <div className="col-span-3 pl-10 font-roboto font-semibold text-xl sm:text-2xl text-my-blue350 w-full">
