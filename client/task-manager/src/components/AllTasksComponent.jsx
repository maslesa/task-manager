...
function AllTasksComponent() {
    ...
    const fetchTasks = async () => {
        const res = await axios.get(`${import.meta.env.VITE_API_BASE_URL}/task/`, axiosConfig);
            ...
            <div className="w-3/4 lg:w-2/3 h-full flex flex-col mb-10">
                <div className="flex items-center justify-between mb-5">
                    <div className="flex gap-1 justify-baseline items-center">
                        ...
                        <h2 className="font-roboto font-black text-2xl sm:text-3xl text-my-blue3">All tasks</h2>
                    </div>
                </div>
