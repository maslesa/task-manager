                ...
                <div className="w-full h-full flex flex-col justify-center items-center">
                    <div className="w-4/6 h-[480px] flex flex-col justify-baseline items-center">
                        ...
                        <div className="w-5/6 h-full flex flex-col gap-5 items-center justify-center">
                            ...
                            <div onClick={updatePassword} className="flex justify-center items-center p-5 border-2 rounded-xl font-roboto font-bold text-my-blue3 cursor-pointer duration-300 ease-in-out hover:text-my-back hover:bg-my-blue3">
                                Change password
                            </div>
                        </div>
                    </div>
