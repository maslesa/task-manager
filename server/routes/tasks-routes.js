...
const {postTask, fetchAllTasks, fetchImportantTasks, fetchTask, updateTask, deleteTask, completeTask, fetchCompletedTasks, fetchUncompletedTasks, fetchTodayTasks} = require('../controllers/tasks-controllers');
...
router.get('/uncompleted',isLoggedIn, fetchUncompletedTasks);
router.get('/today', isLoggedIn, fetchTodayTasks);
